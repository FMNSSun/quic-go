...
type Client struct {
	...
	handshakeChan   chan struct{} // will be closed once the handshake is complete and the header stream has been opened
...
func (c *Client) Do(req *http.Request) (*http.Response, error) {
	...
	<-c.handshakeChan // wait until the handshake has completed
