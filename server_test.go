...
func newMockSession(_ connection, _ protocol.VersionNumber, connectionID protocol.ConnectionID, _ *handshake.ServerConfig, _ []protocol.VersionNumber) (packetHandler, <-chan handshakeEvent, error) {
	s := mockSession{
