...
type server struct {
	...
	newSession func(conn connection, v protocol.VersionNumber, connectionID protocol.ConnectionID, sCfg *handshake.ServerConfig, supportedVersions []protocol.VersionNumber) (packetHandler, <-chan handshakeEvent, error)
}
